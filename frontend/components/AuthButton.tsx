    ...
    return (
        <div className="relative ml-3">
            <button
                ...
                className={minimal 
                    ? "p-2 rounded-full bg-white border border-gray-300 shadow-sm flex items-center justify-center hover:bg-gray-50 transition-colors" 
                    : "flex items-center gap-2 px-3 md:px-4 py-1.5 rounded-full bg-white text-gray-700 font-medium text-xs shadow-sm hover:shadow-md hover:bg-gray-50 active:scale-[0.98] transition-all duration-300 border border-gray-300"
                }
            >
